...
Your professor gave the class a bonus task: 
Write a program that will check the answers for the latest test. 
...
Your task is to return the table with a column id and a column checks, 
