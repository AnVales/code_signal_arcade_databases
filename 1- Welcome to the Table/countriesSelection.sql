...
Given a list of countries, your friend should identify all the countries that are in Africa. 
...
name: the name of the country;continent: the continent on which the country is situated;
continent: the continent on which the country is situated;
population: the country's population.

Your task is to return a new table that has the same columns, 
but that only contains the countries from Africa. 
